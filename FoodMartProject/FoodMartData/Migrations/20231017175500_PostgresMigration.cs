        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SellingCount = table.Column<long>(type: "bigint", nullable: false),
                    ProductId = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnalysisId = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Products", x => x.ProductId);
                    table.ForeignKey(
                        name: "FK_Products_Analysis_AnalysisId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "66997263-5494-4f0e-8a1b-e3ec635e9d84", "1", "Vendor", "Vendor" },
                    { "9d159d60-067e-470a-b6e1-bf2a8426edb5", "2", "Admin", "Admin" },
                    { "ad2a0e7d-e025-4251-a4e0-c1cc4ab34868", "0", "User", "User" }
                });

            migrationBuilder.CreateIndex(
                name: "IX_Analysis_ProductId",
                table: "Analysis",
                column: "ProductId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Analysis_Products_ProductId",
                table: "Analysis",
                column: "ProductId",
